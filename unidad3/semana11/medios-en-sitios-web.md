...
Defining a typology of types of content related to web content and social networks is a tricky task. In the 30 or so years since [the internet was invented](https://www.w3.org/People/Berners-Lee/1991/08/art-6487.txt), so many types of web content and advertisements have been invented, as have techniques for putting ads in front of potential consumers. For the purposes of these course contents, we'll focus upon two typologies that organize content types.

### Typology 1. Big Picture of Content Types

| Tipo | Descripción | Desafíos | Propósito | Dónde encontrarlo |  
|------|-------------|-----------|-------------------|  
| Content page | Descripción | Propósito | Desafíos | Dónde encontrarlo |  
...
| Banners Publicitarios | Anuncios gráficos rectangulares en formatos estándar (IAB) | Generar awareness, dirigir tráfico, promocionar ofertas | Baja tasa de clics (CTR), diseño efectivo | Superior, lateral o inferior de sitios web |  
...
- "[Los inicios de Internet en México](https://www.libros.unam.mx/digital/v6/59.pdf)" by Gloria Koenigsberger - Koenigsberger was one of the pioneers who brought internet to Mexico in 1989 through the Institute of Astronomy
