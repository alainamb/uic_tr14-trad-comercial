...
Esta página establece las bases teóricas necesarias para entender la traducción y transcreación publicitaria. Exploraremos las definiciones fundamentales, la evolución histórica y los principios clave que rigen tanto el marketing como la publicidad, destacando sus diferencias y relaciones.
...
La información presentada aquí es un sintesis de una variedad de recursos. Para entender el markting and la publicidad, recomendamos los siguientes recursos.

- [HubSpot - Introducción al marketing](https://blog.hubspot.es/marketing/introduccion-al-marketing)
- [Asana - Marketing vs. publicidad: ¿cuál es la diferencia?](https://asana.com/es/resources/marketing-vs-advertising-difference)
- Comunicare - [Principio de publicidad](https://www.comunicare.es/principio-de-publicidad) y [Fundamentos de la publicidad](https://www.comunicare.es/fundamentos-de-la-publicidad)
- [Brand Vision - The Epic History of Marketing, Advertising, and Evolution](https://www.brandvm.com/post/the-epic-history-of-marketing-advertising-and-evolution-into-the-modern-day)
- [Britannica - Advertising](https://www.britannica.com/money/advertising)

## Definiciones Fundamentales

El **marketing** es el conjunto de actividades que llevan a cabo las empresas para promocionar sus productos e impulsar las ventas. Estas actividades incluyen desde el análisis del mercado y el comportamiento de los consumidores hasta el desarrollo de estrategias, la ejecución de acciones y el seguimiento de indicadores de rendimiento. El marketing es una disciplina que abarca todo el proceso, desde la identificación de oportunidades hasta la satisfacción del cliente, mientras que la publicidad se centra en la etapa de promoción dentro de ese proceso.

La **publicidad** es "la práctica y las técnicas empleadas para llamar la atención sobre un producto o servicio" ([Britannica](https://www.britannica.com/money/advertising)) La publicidad tiene como objetivo presentar un producto o servicio en términos de utilidad, ventajas y cualidades de interés para los consumidores. Típicamente se utiliza para promover un bien o servicio específico, aunque existe una amplia gama de usos, siendo el más común la publicidad comercial.

**En resumen**: El marketing es la estrategia integral que una empresa desarrolla para conectar con su mercado objetivo. La publicidad es una herramienta específica dentro del marketing que se enfoca en la comunicación persuasiva y pagada.
...
### 2. Precio (Price)
El precio es un factor clave en el terreno del marketing y la publicidad. Para ponerle el precio adecuado a un producto, hay muchos factores que deben tenerse en cuenta: objetivos económicos de la empresa, margen suficiente, percepción del producto, expectativas del público objetivo y respuesta coherente a las acciones de la competencia.

### 3. Plaza (Place/Distribución)
...
Para que una campaña publicitaria esté bien planteada y pueda cumplir su objetivo de captar la atención de los consumidores, debe cumplir estos principios básicos:
...
Los egipcios usaban papiro para crear mensajes de ventas y carteles murales. Se han encontrado mensajes comerciales y exhibiciones de campañas políticas en las ruinas de Pompeya y Arabia antigua ([Britannica](https://www.britannica.com/money/advertising)).

El primer paso hacia la publicidad moderna vino con el desarrollo de la imprenta en los siglos XV y XVI. En el siglo XVII, los periódicos semanales en Londres comenzaron a llevar anuncios, y para el siglo XVIII, tal publicidad estaba floreciendo.
...
**[Brand Vision](https://www.brandvm.com/post/the-epic-history-of-marketing-advertising-and-evolution-into-the-modern-day)** explica que en la era digital, "los motores de búsqueda como Google redefinieron cómo los consumidores encontraban información, dando nacimiento a la disciplina del SEO. Los anuncios de búsqueda pagados, introducidos por Google AdWords en 2000, permitieron a las marcas dirigirse a palabras clave específicas, pagando solo cuando los usuarios hacían clic."
...
**Próxima actividad**: [El Recorrido del Comprador](recorrido-del-comprador.md)
