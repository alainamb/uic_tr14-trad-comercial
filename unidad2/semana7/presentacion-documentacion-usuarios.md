...
**Alaina:** It sounds like since you have so many different processes already in place or just well-defined and established processes, that probably helps you speed achieve the speed necessary to attend to name changes while you can also sort of come in where you're using the newsletter to achieve that stakeholder that’s ongoing and…
